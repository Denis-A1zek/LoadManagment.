...
namespace Sigida.LoadManagment.Infrastructure.Migrations
{
    ...
    [Migration("20230604193306_add_course_and_semester-To_subjectSchedule")]
    partial class add_course_and_semesterTo_subjectSchedule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sigida.LoadManagment.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e288436d-c4ce-45aa-b5fd-4e4dfb3506fa"),
                            MaxLoad = 600.0,
                            MinLoad = 0.0,
                            Title = "Доцент"
                        },
                        new
                        {
                            Id = new Guid("8eb290bf-79dc-45b7-9915-b6fdb4c3a117"),
                            MaxLoad = 800.0,
                            MinLoad = 0.0,
                            Title = "Ассистент"
                        },
                        new
                        {
                            Id = new Guid("af43dd23-3a9f-4892-b44c-fbf21154f5da"),
                            MaxLoad = 900.0,
                            MinLoad = 0.0,
                        ...
                        new
                        {
                            Id = new Guid("2c56322f-6f32-4148-8924-d7b99960f2aa"),
                            MaxLoad = 1200.0,
                            MinLoad = 0.0,
                            Title = "Профессор"
                        });
